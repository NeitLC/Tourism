                                            ...
                                            <div className="col-md-12">
                                                {res.map((detail) => 
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-2">
                                                            {detail['reservation']['ticket'] !== '0' ?
                                                                detail['reservation']['ticket'] :
                                                                <ButtonTicket id={detail['reservation']['id']} />
                                                            }
                                                        </div>
                                                        <div className="col-md-2">
                                                            {detail['reservation']['checkin'] !== '0' ?
                                                                detail['reservation']['checkin'] :
                                                                <ButtonCheckin id={detail['reservation']['id']} />
                                                            }
                                                        </div>
                                                        <div className="col-md-12">
                                                            <hr/>
